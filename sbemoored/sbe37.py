...
def read_sbe_cnv(file, lat=0, lon=0):
    ...
    # Parse the data structure generated by the Seabird package. Some SBE37
    # data files do not contain time as a variable.
...
def time_offset(tds, insttime, utctime):
    """Calculate and apply time offset to SBE37 time series
